    ...
    <div className="relative mb-4 mt-auto flex w-full max-w-screen-2xl flex-col gap-7">
      <div id="teste" className="flex w-full items-center justify-center">
        <form
          ...
          className="flex w-full max-w-5xl flex-col items-center justify-center rounded-2xl bg-gray-100 px-5 py-8 text-gray-900 lg:px-8"
        >
      ...
      <div
        onMouseEnter={!isMobile ? footerEnter : () => {}}
        onMouseLeave={!isMobile ? footerLeave : () => {}}
        className="flex w-full flex-col items-center rounded-2xl bg-gray-100 px-5 pb-5 pt-14  lg:px-20 lg:pb-10"
      >
