...
export default function Profile() {
	...
	return (
		<div className="bg-[url('/bg-hero-medium.svg')] -mt-10 bg-cover max-w-7xl bg-no-repeat bg-center w-full h-[980px] flex items-center justify-center flex-col">
			<motion.div
				initial={{ opacity: 0 }}
			...
			>
				<motion.h1 className="font-semibold text-4xl font-sans">
					Hi there <span className="text-xl">👋🏻 I&apos;m</span>
				</motion.h1>
				<span className="text-3xl font-semibold">{Me.name}</span>
				<span className="text-xl mt-4">{Me.role}</span>
			</motion.div>
