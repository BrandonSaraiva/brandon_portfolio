...
export const Me: Me = {
	...
	projects: [
...

		{
			...
			description:
				'Desenvolvi um projeto de análise descritiva dos dados das Eleições Gerais Ordinárias no Brasil em 2022, focado no Distrito Federal. Utilizei PostgreSQL como banco de dados e Python/SAS para a análise. Destaquei padrões, tendências e insights relevantes nos resultados eleitorais. Essa experiência aprimorou minhas habilidades como desenvolvedor Python e contribuiu para a compreensão do processo eleitoral.',
			thumbnail:
		...
		},
		{
			...
			description:
				'Aplicação que investiga a relação entre internações, duração da estadia hospitalar e mortalidade. utilizando dados públicos do Ministério da Saúde para analisar o número de internações, mortes e a duração média da hospitalização por procedimento em cada município brasileiro. A aplicação oferece insights sobre padrões e correlações, contribuindo para melhorar os serviços de saúde.',
			tags: ['Python', 'Kivy', 'Plyer'],
